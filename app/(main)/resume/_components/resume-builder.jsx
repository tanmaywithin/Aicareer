...
export default function ResumeBuilder({ initialContent }) {
  ...
  // Handle AI improvement results for summary
  useEffect(() => {
    ...
    if (summaryError) {
      toast.error(summaryError.message || "Failed to improve summary");
    }
  }, [improvedSummary, summaryError, isImprovingSummary, setValue]);

  // Handle AI improvement results for skills
  useEffect(() => {
  ...
  const resetForm = () => {
    if (
      window.confirm(
        "Are you sure you want to start a new resume? All unsaved changes will be lost."
      )
    ) {
      reset({
        contactInfo: {
